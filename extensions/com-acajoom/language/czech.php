...
define('_ACA_SUB_INFO', 'Uživatelské údaje');
define('_ACA_VERIFY_INFO', 'Please verify the link you submitted, some information are missing.');
define('_ACA_INPUT_NAME', 'Jméno');
define('_ACA_INPUT_EMAIL', 'Email');
define('_ACA_RECEIVE_HTML', 'Přijímat HTML?');
define('_ACA_TIME_ZONE', 'Časová zóna');
...
define('_ACA_SUBSCRIPTIONS', 'Vaše registrace');
...
define('_ACA_UNSUBSCRIBE_MESSAGE', 'Jste si jisti, že se chcete odhlásit z uvedeného seznamu?');
define('_ACA_MOD_SUBSCRIBE', 'Subscribe');
define('_ACA_SUBSCRIBE', 'Přihlásit');
define('_ACA_UNSUBSCRIBE', 'Odhlásit');
define('_ACA_VIEW_ARCHIVE', 'View archive');
define('_ACA_SUBSCRIPTION_OR', ' nebo přejděte na editaci vašeho nastavení');
...
define('_ACA_FREQ_CH1', 'Každou hodiny');
define('_ACA_FREQ_CH2', 'Každých 6 hodin');
define('_ACA_FREQ_CH3', 'Každých 12 odin');
define('_ACA_FREQ_CH4', 'Denně');
define('_ACA_FREQ_CH5', 'Týdně');
define('_ACA_FREQ_CH6', 'Měsíčně');
define('_ACA_FREQ_NONE', 'Nikdy');
define('_ACA_FREQ_NEW', 'Noví uživatelé');
define('_ACA_FREQ_ALL', 'Všichni uživatelé');
...
define('_ACA_CHANGE_EMAIL_SUBSCRIPTION', 'Změnit registraci');
...
define('_ACA_INPUT_NAME_TIPS', 'Uveďte celé jméno (křestní první)');
define('_ACA_INPUT_EMAIL_TIPS', 'Uveďte emailovou adresu (Ujištěte se, že adresa je platná a správně zadaná)');
define('_ACA_RECEIVE_HTML_TIPS', 'Vyberte, zda chcete přijímat HTML nebo jen textové emaily.');
define('_ACA_TIME_ZONE_ASK_TIPS', 'Uveďte časové pásmo.');
