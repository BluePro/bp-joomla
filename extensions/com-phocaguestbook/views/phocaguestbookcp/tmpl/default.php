...
<table class="adminform">
	...
	?>
		...
		<td width="45%" valign="top">
			...
			<div style="border: 1px solid #bf3030;color:#bf3030;background:#ffc2c2;padding: 10px;"><?php echo JText::_('SECURITY PARAMETERS SETTINGS');?><br /><a href="http://www.phoca.cz/documents/3-phoca-guestbook-component/436-trying-to-prevent-from-spam" style="text-decoration:underline;" target="_blank">Trying to prevent from spam</a></div>
